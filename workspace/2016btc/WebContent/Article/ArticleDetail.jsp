...
<body>
	<div class="contents">
		...
		<div class="container">
			...
			<div class="main">
				<h3 class="title center">記事詳細</h3>
				<table border=1 width=800>
					<tr>
						<td>記事タイトル</td>
						<td width=600><%=request.getParameter("title")%></td>
					</tr>
					<tr>
						<td>登録者</td>
					...
					<tr>
						<td>リンク</td>
						<td><a href="<%=request.getParameter("url")%>"><%=request.getParameter("url")%></td>
					</tr>
					<tr>
						<td>記事概要</td>
						<td style="width: 600px; height: 80px;">yahoo的な検索サイト</td>
					</tr>
					<tr>
						<td colspan=2>
							<form action="CommentEdit.html" method="get">
								コメント <input type="submit" value="編集">
						</td>
					</tr>
					<tr>
						<td colspan=2 style="width: 800px; height: 100px;">
							ここにコメントが上から順に並ぶ予定です<br> 日付とかコメントした人の名前とかも一緒に表示でいいかも？（遠藤）
							<%=request.getParameter("comment")%>
						</td>
						</form>
					<tr>
						<td colspan=2>
							<form action="" method="get">コメント書き込み
						</td>
					</tr>
					<tr>
						<td colspan=2><textarea name="addcomment" style="width: 100%"
								maxlength="140" rows="4"
								placeholder="ここにコメントを書き込んでください（maxlength140）"></textarea> <!-- テキストエリアの中に文字入れるとplaceholderが見えなくなる　　↑ここの間-->
				</table>
				<input type="submit" value="コメント投稿"> <INPUT type="button"
